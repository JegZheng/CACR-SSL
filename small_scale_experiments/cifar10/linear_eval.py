...
def parse_option():
    parser = argparse.ArgumentParser('Evalaution: CIFAR10 Representation Learning')
    parser.add_argument('--encoder_checkpoint', type=str, default=None, help='Encoder checkpoint to evaluate')
...
def get_data_loaders(opt):
    ...
    train_dataset = torchvision.datasets.CIFAR10(opt.data_folder, train=True, download=True, transform=train_transform)
    val_dataset = torchvision.datasets.CIFAR10(opt.data_folder, train=False, transform=val_transform)
